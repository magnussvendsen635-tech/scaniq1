        ...
        messages: [
          {
            ...
            content:
              ...
              "  • RESTAURANT / FÆRDIGRET / FAST FOOD / SANDWICH / BURGER / WRAP: skjulte kilder må ALDRIG være 0. Selv hvis du ikke kan se dressingen tydeligt, ved du at den er der. Giv et realistisk estimat. " +
              "  • RÅVARE-UNDTAGELSE: Et helt æble, en banan, et glas vand, en rå agurk → `hiddenSourcesEstimateKcal` = 0. " +
              "  • RECOGNISED BRAND/CHAIN CONTEXT: Når du kan identificere et standardiseret kæde-/pakkeprodukt (Big Mac, Whopper, Pringles, Snickers osv.), brug brandets officielle kalorieindhold frem for et rent visuelt skøn. " +
              "  • NOVA-LOGIK (nuanceret men streng for sammensatte måltider): " +
              "      - Sandwich, burger, wrap, pizza, pasta, færdigret eller cafe-/restaurantmåltid → MINIMUM NOVA 3 (brød + sammensætning er forarbejdet). " +
              "      - NOVA 4 KUN ved tydeligt industrielle additiver/færdigpakkede fabriksprodukter (sodavand, chips, slik, instant nudler, energidrik, fastfood-kæde-produkter, færdigpakkede kager). " +
              "      - NOVA 1 KUN til rene råvarer (et æble, rå broccoli, rent ubehandlet kød). " +
