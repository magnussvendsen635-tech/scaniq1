      ...
      <div className="k-card p-5 space-y-5 text-sm leading-relaxed text-foreground/90">
        ...
        <Section title="1. Who we are">
          <p>
            ...
            your data, contact us at <a className="text-primary-glow underline" href="mailto:support@kcally.app">support@kcally.app</a>.
          </p>
        </Section>
        ...
        <Section title="8. Your rights">
          ...
          <p className="mt-2">
            To use any of these rights, email <a className="text-primary-glow underline" href="mailto:support@kcally.app">support@kcally.app</a>.
        ...
        <Section title="13. Contact">
          <p>
            Prime Studio · <a className="text-primary-glow underline" href="mailto:support@kcally.app">support@kcally.app</a>
          </p>
        </Section>
      </div>
    </div>
